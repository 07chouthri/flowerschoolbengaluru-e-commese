  ...
  return (
    <div className="space-y-4">
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          <Label htmlFor="email">Email Address * (must end with .com)</Label>
          <Input
            id="email"
            type="email"
            {...form.register("email")}
      ...
      <header className="border-b bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <Link to="/" data-testid="link-home" onClick={() => window.scrollTo({ top: 0, left: 0, behavior: "auto" })}>
              <img
                src={bouquetBarLogo}
                alt="Bouquet Bar"
        ...
        {!isLoading && items.length === 0 && (
          <Card className="text-center py-8 sm:py-12 mx-2 sm:mx-0" data-testid="card-empty-cart">
            <CardContent className="space-y-4 px-4">
              ...
              <Link to="/shop" data-testid="link-continue-shopping" onClick={() => window.scrollTo({ top: 0, left: 0, behavior: "auto" })}>
                    ...
                    <CardContent className="px-2 sm:px-6">
                      ...
                      {!isLoading && items.length > 0 && (
                        <div className="flex flex-col sm:flex-row justify-between items-center mt-4 sm:mt-6 pt-4 border-t gap-4">
                          ...
                          <Link to="/shop" className="w-full sm:w-auto order-1 sm:order-2" onClick={() => window.scrollTo({ top: 0, left: 0, behavior: "auto" })}>
                      ...
                      <div className="flex flex-col sm:flex-row justify-between pt-4 gap-4">
                        <Link to="/shop" className="w-full sm:w-auto" onClick={() => window.scrollTo({ top: 0, left: 0, behavior: "auto" })}>
