...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-br from-pink-50 to-purple-100 text-gray-900 border-t border-pink-200">
      <div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="grid md:grid-cols-4 gap-10 mb-16">
            ...
            <div className="space-y-6">
              <h4 className="text-xl font-semibold text-gray-900 border-b-2 border-pink-300 pb-2 inline-block">Company</h4>
