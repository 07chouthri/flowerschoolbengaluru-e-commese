    ...
    <section id="shop" className="section-padding">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Our Flower Shop</h2>
          <p className="text-xl text-muted-foreground">Premium fresh flowers delivered to your doorstep</p>
        </div>
